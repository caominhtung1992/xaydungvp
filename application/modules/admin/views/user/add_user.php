    ...
    <div class="group">
      <div class="group-fields">
        ...
        <dl>
          ...
          <dd>
            <input type="text" size="60" name="user_name" value="" />
          </dd>
          <dt class="top">
            <label for="custom_collection_title">Mật khẩu</label>
          </dt>
          <dd>
            <input type="password" size="60" name="user_pass" value="" />
          </dd>
          <dt class="top">
          ...
          <dd>
            <input type="text" size="60" name="user_fullname" value="" />
          </dd>
          <dt class="top">
          ...
          <dd>
            <input type="text" size="60" name="user_phone" value="" />
          </dd>
          <dt class="top">
            <label for="custom_collection_title">Email</label>
          </dt>
          <dd>
            <input type="text" size="60" name="user_email" value="" />
          </dd>
          ...
          <dd>
            <input type="text" size="60" name="user_address" value="" />
          </dd>
        </dl>
      </div>
      <!-- .group-fields -->
